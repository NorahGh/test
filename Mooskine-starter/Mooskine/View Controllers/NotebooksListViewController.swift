...
class NotebooksListViewController: UIViewController, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    fileprivate func settingFetchResultController() {
        let fetchReq : NSFetchRequest<Notebook> = Notebook.fetchRequest()
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        if let numberOfSections = fetchResultsController.sections?.count
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let count = aNotebook.note?.count
